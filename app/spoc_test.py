...
def thread_test_spoc(tid, file_list, dlist, out_base):
    ...
    for dir in dlist:
        ...
        for f in flist:
            ...
            save_npy = os.path.join(out_base, dat_name)
...
def extract_test_spoc(thread_num=1, test=1):
    ...
    for tid in range(thread_num):
        ...
        task = pop.task(func=thread_test_spoc, args=(tid+1, (start,end), dlist, out_base))
        task.run()
...
if __name__ =='__main__':
    extract_test_spoc(thread_num=20, test=1)   
